...
class UART: private UART_Common, private IF<(Traits<Build>::MODEL == Traits<Build>::SiFive_U), NS16500A, SiFive_UART>::Result
{
private:
    ...
    typedef IF<(Traits<Build>::MODEL == Traits<Build>::SiFive_U), NS16500A, SiFive_UART>::Result Engine;
